...
//            resource = PHAssetResource.assetResources(for: phAsset).filter { if #available(iOS 9.1, *) {
//                $0.type == .pairedVideo
//            } else {
//                // Fallback on earlier versions
//                } }.first
...
//        if #available(iOS 9.0, *) {
//            resource = PHAssetResource.assetResources(for: phAsset).filter { $0.type == .video }.first
//        } else {
//            // Fallback on earlier versions
//        }
//        if let fileSize = resource?.value(forKey: "fileSize") as? Int {
